...
const MOCK_EMPLOYEES: Employee[] = [
  ...
  },
  {
    ...
    name: 'Bob Martinez',
    role: 'Developer',
    avatar: `${import.meta.env.BASE_URL}avatars/bob.jpg`,
    schedule: buildSchedule([
  ...
  },
  {
    ...
    name: 'Carol Chen',
    role: 'Designer',
    avatar: `${import.meta.env.BASE_URL}avatars/carol.jpg`,
    schedule: buildSchedule([
  ...
  },
  {
    ...
    name: 'David Kim',
    role: 'Support',
    avatar: `${import.meta.env.BASE_URL}avatars/david.jpg`,
    schedule: buildSchedule([
  ...
  },
  {
    ...
    name: 'Eva Patel',
    role: 'QA Engineer',
    avatar: `${import.meta.env.BASE_URL}avatars/eva.jpg`,
    schedule: buildSchedule([
  ...
  },
  {
    ...
    name: 'Frank Wilson',
    role: 'DevOps',
    avatar: `${import.meta.env.BASE_URL}avatars/frank.jpg`,
    schedule: buildSchedule([
  ...
  },
  {
    ...
    name: 'Grace Lee',
    role: 'Analyst',
    avatar: `${import.meta.env.BASE_URL}avatars/grace.jpg`,
    schedule: buildSchedule([
  ...
  },
  {
    ...
    name: 'Henry Davis',
    role: 'Manager',
    avatar: `${import.meta.env.BASE_URL}avatars/henry.jpg`,
    schedule: buildSchedule([
      'morning', 'morning', 'morning', 'morning', 'morning', 'off', 'off',
    ]),
  },
...
const MOCK_SWAP_REQUESTS: SwapRequest[] = [
  {
    id: 'sw-1',
    requester: { name: 'Bob Martinez', avatar: `${import.meta.env.BASE_URL}avatars/bob.jpg` },
    originalShift: 'Morning (Jun 19)',
    requestedShift: 'Afternoon (Jun 19)',
    swapWith: { name: 'Carol Chen', avatar: `${import.meta.env.BASE_URL}avatars/carol.jpg` },
    date: 'Jun 19, 2026',
    status: 'pending',
  },
  {
    id: 'sw-2',
    requester: { name: 'Eva Patel', avatar: `${import.meta.env.BASE_URL}avatars/eva.jpg` },
    originalShift: 'Afternoon (Jun 20)',
    requestedShift: 'Morning (Jun 20)',
    swapWith: { name: 'Alice Johnson', avatar: `${import.meta.env.BASE_URL}avatars/alice.jpg` },
    date: 'Jun 20, 2026',
    status: 'pending',
  },
  {
    id: 'sw-3',
    requester: { name: 'David Kim', avatar: `${import.meta.env.BASE_URL}avatars/david.jpg` },
    originalShift: 'Night (Jun 16)',
    requestedShift: 'Morning (Jun 16)',
    swapWith: { name: 'Frank Wilson', avatar: `${import.meta.env.BASE_URL}avatars/frank.jpg` },
    date: 'Jun 16, 2026',
    status: 'approved',
  },
  {
    id: 'sw-4',
    requester: { name: 'Grace Lee', avatar: `${import.meta.env.BASE_URL}avatars/grace.jpg` },
    originalShift: 'Afternoon (Jun 15)',
    requestedShift: 'Morning (Jun 15)',
    swapWith: { name: 'Henry Davis', avatar: `${import.meta.env.BASE_URL}avatars/henry.jpg` },
    date: 'Jun 15, 2026',
    status: 'rejected',
  },
  {
    id: 'sw-5',
    requester: { name: 'Frank Wilson', avatar: `${import.meta.env.BASE_URL}avatars/frank.jpg` },
    originalShift: 'Morning (Jun 22)',
    requestedShift: 'Afternoon (Jun 22)',
    swapWith: { name: 'Bob Martinez', avatar: `${import.meta.env.BASE_URL}avatars/bob.jpg` },
    date: 'Jun 22, 2026',
    status: 'pending',
  },
];
